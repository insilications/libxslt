...
Version  : 20.07.26
Release  : 50
URL      : file:///insilications/build/clearlinux/packages/libxslt/libxslt-20.07.26.zip
Source0  : file:///insilications/build/clearlinux/packages/libxslt/libxslt-20.07.26.zip
...
Patch1: 0001-Fix-install-with-no-docs.patch
...
%prep
%setup -q -n libxslt-20.07.26
cd %{_builddir}/libxslt-20.07.26
%patch1 -p1
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595811153
